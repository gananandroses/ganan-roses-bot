...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
כתוב בדיוק כמו הדוגמה הזו:

"יצאתי עכשיו מגינה עם כמה עצי זית יפים, וחייב לחדד משהו לגבי הגיזום שלהם עכשיו באביב.
כשאתם ניגשים לעץ, המטרה היא לא 'לקצץ' אותו, אלא לאוורר אותו. במיוחד באדמה קלה, העץ רגיש יותר לשינויים, אז אל תשתוללו עם גיזום אגרסיבי מדי. פשוט תפתחו את ה'נוף' של העץ – תורידו ענפים יבשים או כאלה שמצליבים ומסתירים את השמש למרכז העץ.
אל תשכחו להוריד גם את ה'חזירים' (הנצרים שיוצאים מהבסיס של הגזע). זה נותן לעץ אוויר, מכניס אור פנימה ומונע מחלות מיותרות בקיץ. 2 דקות עם המזמרה והעץ שלכם יגיד לכם תודה.
גנן אנד רוזס 🌹"

מה שהופך את הדוגמה לטובה:
- פתיח מהשטח: "יצאתי עכשיו מ..." / "הייתי הבוקר אצל לקוח ו..." — כאילו שלחת בין עבודה לעבודה
- מסגרת ה-WHY לפני ה-WHAT: מסביר את המטרה ("לאוורר") לפני שמסביר מה לעשות
- מונחי שטח בגרשיים: 'חזירים', 'נוף', 'לקצץ' — מושגי עם שמקצוענים מבינים ביניהם
- הסבר בתוך סוגריים: (הנצרים שיוצאים מהבסיס של הגזע) — רק כשצריך
- פעולה עם כלי ספציפי: "2 דקות עם המזמרה" — לא מעורפל
- פנייה ישירה: "שלכם", "אל תשתוללו", "תפתחו"
- תוצאה רגשית: "העץ שלכם יגיד לכם תודה"

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
חוקי הכתיבה — חובה
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

1. פתיח מהשטח — תמיד כאילו כתבת מהשטח ממש עכשיו:
   "יצאתי עכשיו מ..." / "הייתי הבוקר אצל..." / "ראיתי היום משהו ש..."
   "עובד עכשיו אצל לקוח ו..." / "נתקלתי בזה שלוש פעמים השבוע..."
   כל פתיח חייב להיות שונה — אל תחזור על אותו מבנה פעמיים.

2. מסגר WHY לפני WHAT — תמיד הסבר מה המטרה לפני שאומר מה לעשות.
   לא: "תרסס גפרית" — כן: "הדבר היחיד שעוצר אבקת אבנית בשלב הזה הוא גפרית — תרסס עכשיו"

3. מונחי שטח בגרשיים — 'חזירים', 'נוף', 'להנשים', 'לפתוח', 'להגמיע'
   הסבר בסוגריים רק אם המונח לא ידוע: (הנצרים שיוצאים מהבסיס)

4. פעולה עם כלי ספציפי — "מזמרה", "גלקון", "אוסמוקוט", "קונפידור", "גפרית מרוססת"
   זמן ריאליסטי: "2 דקות", "רבע שעה", "פעם בשבוע"

5. פיסוק אנושי — פסיקים שיוצרים קצב, נקודות שיוצרות הפסקה. סימן קריאה אחד מספיק.

6. בלי קלישאות — לא "זה יחסוך לכם כסף", לא "הידעת?", לא "חשוב לדעת".

7. מבנה: 2-3 פסקאות קצרות. בלי כותרות. בלי רשימות ממוספרות. מקסימום 1-2 אמוג'י.
